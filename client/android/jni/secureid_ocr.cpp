...
extern "C" JNIEXPORT jintArray Java_com_attafitamim_mtproto_client_android_core_MrzRecognizer_findCornerPoints(JNIEnv* env, jclass clasz, jobject bitmap){
...
extern "C" JNIEXPORT jobjectArray Java_com_attafitamim_mtproto_client_android_core_MrzRecognizer_binarizeAndFindCharacters(JNIEnv* env, jclass clasz, jobject inBmp, jobject outBmp){
...
extern "C" JNIEXPORT jstring Java_com_attafitamim_mtproto_client_android_core_MrzRecognizer_performRecognition(JNIEnv* env, jclass clasz, jobject bitmap, jint numRows, jint numCols, jobject jAssetManager){
...
extern "C" JNIEXPORT void Java_com_attafitamim_mtproto_client_android_core_MrzRecognizer_setYuvBitmapPixels(JNIEnv* env, jclass clasz, jobject bitmap, jbyteArray jpixels){
