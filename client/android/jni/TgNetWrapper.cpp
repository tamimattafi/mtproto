...
static const char *NativeByteBufferClassPathName = "com/attafitamim/mtproto/client/android/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "com/attafitamim/mtproto/client/android/tgnet/ConnectionsManager";
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("com/attafitamim/mtproto/client/android/tgnet/RequestDelegateInternal"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("com/attafitamim/mtproto/client/android/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("com/attafitamim/mtproto/client/android/tgnet/ConnectionsManager"));
