...
public class NotificationCenter {
    ...
    public static final int loadOutDialog = totalEvents++;
    public static final int deletedOutDialog = totalEvents++;

    public static final int balanceEvent = totalEvents++;
    public static final int balanceFullEvent = totalEvents++;
    public static final int walletConfigEvent = totalEvents++;
    public static final int createTransactionEvent = totalEvents++;
    public static final int createTransactionError = totalEvents++;
    public static final int sendTransactionEvent = totalEvents++;
    public static final int newTransactionEvent = totalEvents++;
    public static final int transactionInfoEvent = totalEvents++;
    public static final int loadDialogsMailEvent = totalEvents++;
    public static final int openDialogMail = totalEvents++;
    public static final int loadDialogMailItemEvent = totalEvents++;
    public static final int newEmail = totalEvents++;
    public static final int newEmailWithUser = totalEvents++;
    public static final int deleteEmailDialog = totalEvents++;
    public static final int sendEmail = totalEvents++;
    public static final int deletedEmail = totalEvents++;
    public static final int sendSms = totalEvents++;
    public static final int sendSmsError = totalEvents++;
    public static final int createDialogMail = totalEvents++;
