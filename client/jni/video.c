...
JNIEXPORT jint Java_com_attafitamim_mtproto_client_core_Utilities_convertVideoFrame(JNIEnv *env, jclass class, jobject src, jobject dest, jint destFormat, jint width, jint height, jint padding, jint swap) {
